...
def region_of_interest(image):
    ...
    # Creates an array of 0 with the same shape of the image's corresponding
    # array
    mask = np.zeros_like(image)
    cv2.fillPoly(mask, polygons, 255)
    # Computing the bitwise & of both images, takes the bitwise & of each
    # homologous pixel in both arrays, masking the canny imaege to only show
...
#----------------------------------- Main --------------------------------------
# Read the image from the file - Return the image as a multi-dimentional numpy
# array containing the relative intensity of each pixel in the image
# image = cv2.imread('test_image.jpg')
#
# # Copy of the image - hard copy
...
# # Displays the image for specified amount of miliseconds
# cv2.waitKey(0)
